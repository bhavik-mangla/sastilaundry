...
class EditListingBS extends StatefulWidget {
  EditListingBS({
  ...
  final String phone;
  @override
  State<EditListingBS> createState() => _EditListingBSState();
}

class _EditListingBSState extends State<EditListingBS> {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider<CountProvider>(
      create: (context) => CountProvider(widget.count),
      child: Scaffold(
        backgroundColor: Colors.black,
        appBar: AppBar(
          title: const Text('Edit a Listing'),
                      ...
                      builder: (context, countProvider, _) => TextButton(
                        ...
                        onPressed: _isButtonEnabled
                            ? () async {
                                ...
                                _currentPhone = _currentPhone ?? widget.phone;
                                count1 = countProvider.count;
